...
# function simulate_poits(points)
#     # points = [(x_start, y_start), (x1,y1), (x2,y2), ..., (xn-1,yn-1), (x_finish, y_finish)]
#     println("Start loop for any points")
#     n = length(points)
#     time_step = 0.5
#     max_speed = 3.0
#     ship = Ship_Module.Ship(poits[0][0], poits[0][1], poits[n-1][0], poits[n-1][1], max_speed, [], time_step)
...
find_possible_points(g, node_positions, 6)